                    ...
                    <table style="width: 100%" class="table inventory">
                        <tr>
                            <td style=" !important; text-align:center;" colspan="2">
                                <span style="text-align:center; font-weight:bold; font-size:25px;">SALES TAX INVOICE</span>
                            </td>
                        </tr>
                        <tr>
                      ...
                      <table class="inventory">
                          <thead>
                              <tr>
                                  ...
                                  <!-- <th style="width:15% !important"><span>S No.</span></th> -->
                                  <th style="width:65% !important"><span>Description</span></th>
                                  <th style="width:35% !important"><span>Tax</span></th>
                                  <!-- <th style="width:10% !important"><span>Model</span></th>
                                  <th style="width:10% !important"><span>Brand</span></th> -->
                                  <th style="width:25% !important"><span>Unit Price</span></th>
                                  <th style="width:25% !important"><span>Total</span></th>
                              </tr>
                          </thead>
                          <tbody>
                              @if($products)
                            {{-- {{dd($products)}} --}}
                              ...
                              <tr>
                                  ...
                                  <td  style="text-align:center;">{{($p->total*$invoices->tax)/100}}</td>
                            ...
                            <table class="table">
                                <tr>
                                    <td style=" padding:10px 50px">
                                        <span><b>Notes</b></span>
                                    <div style="border:2px solid black; padding:10px; white-space:pre-line">
