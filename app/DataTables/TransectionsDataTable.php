...
class TransectionsDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Transections $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Transections $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            'type' => new Column(['title' => __('models/transections.fields.type'), 'data' => 'type']),
            'amount' => new Column(['title' => __('models/transections.fields.amount'), 'data' => 'amount']),
            'bank_id' => new Column(['title' => __('models/transections.fields.bank_id'), 'data' => 'bank_id']),
            'cheque_no' => new Column(['title' => __('models/transections.fields.cheque_no'), 'data' => 'cheque_no']),
            'created_by' => new Column(['title' => __('models/transections.fields.created_by'), 'data' => 'created_by'])
        ];
    }
    ...
    {
        return 'transections_datatable_' . time();
    }
}
